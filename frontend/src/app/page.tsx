    ...
    <main className="antialiased text-gray-600 grid grid-flow-row">
      ...
      <div className="px-2 py-20 md:px-10 bg-slate-950">
        ...
        <p className="py-2">
          ...
          You are free to <a className="link text-indigo-800 hover:text-indigo-500" target="_blank" href="https://github.com/proprietary/prv.ec">fork this software</a> and white-label it on your own domain for your brand.
